	...
	(
		...
		parameter  C_M00_AXI_START_DATA_VALUE	= 32'h4,
		parameter  C_M00_AXI_TARGET_SLAVE_BASE_ADDR	= 32'h41E00030,
		parameter integer C_M00_AXI_ADDR_WIDTH	= 32,
		parameter integer C_M00_AXI_DATA_WIDTH	= 32,
		parameter integer C_M00_AXI_TRANSACTIONS_NUM	= 13,

		// Parameters of Axi Master Bus Interface M01_AXI
		parameter  C_M01_AXI_START_DATA_VALUE	= 32'h4,
		parameter  C_M01_AXI_TARGET_SLAVE_BASE_ADDR	= 32'h44A00000,
		parameter integer C_M01_AXI_ADDR_WIDTH	= 32,
		parameter integer C_M01_AXI_DATA_WIDTH	= 32,
		parameter integer C_M01_AXI_TRANSACTIONS_NUM	= 11
	)
	(
        ...
        output wire [31:0] PL_ADDRM0_BRAM,
        input wire [31:0] PL_ADDRM1_BRAM,
        
        output wire PL_STARTM0_CDMA,
        input wire PL_STARTM1_CDMA,
		// User ports ends
...
// Instantiation of Axi Bus Interface M01_AXI
	...
	) init_dma_v4_v4_0_M01_AXI_inst (

	     .M_PL_LEN_REF(PL_LEN_REF),
	     .M_PL_ADDR_BRAM(PL_ADDRM1_BRAM),
	     .M_PL_START_CDMA(PL_STARTM1_CDMA),
    ...
    assign PL_ADDRM1_BRAM = PL_ADDRM0_BRAM;
