...
proc update_MODELPARAM_VALUE.C_M00_AXIS_START_COUNT { MODELPARAM_VALUE.C_M00_AXIS_START_COUNT } {
	# Procedure called to update HDLPARAM_C_M00_AXIS_START_COUNT when any of the dependent parameters in the arguments change
}

proc validate_MODELPARAM_VALUE.C_M00_AXIS_START_COUNT { MODELPARAM_VALUE.C_M00_AXIS_START_COUNT } {
	# Procedure called to validate HDLPARAM_C_M00_AXIS_START_COUNT
	return true
}
